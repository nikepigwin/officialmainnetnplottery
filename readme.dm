...
// Dummy function to force script hash change
fn dummy_version_bump() -> Int {
  1
}
...
name = "van/nikepiglottery"
version = "0.0.0"
compiler = "v1.1.17"
plutus = "v3"
license = "Apache-2.0"
description = "Aiken contracts for project 'van/nikepiglottery'"

[repository]
user = "van"
project = "nikepiglottery"
platform = "github"
...
[config]
entrypoints = { lottery = "validators/mainlottery.ak" }
